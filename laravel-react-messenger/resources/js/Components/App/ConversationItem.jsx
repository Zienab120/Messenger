...
import * as GroupAvatar from "react/jsx-runtime.js";
import * as UserAvatar from "react/jsx-runtime.js";
import * as UserOptionsDropdown from "react/jsx-runtime.js";
...
const ConversationItem = ({
    ...
    return(
        ...
        + classes + (conversation.is_user && currentUser.is_admin ? "pr-2" : "pre-4")}
        >
            ...
            >
                <div className="flex gap-1 justify-between items-center">
                    <h3 className="text-sm text-semibold overflow-hidden text-nowrap text-ellipsis">
                        {conversation.name}
                    </h3>
